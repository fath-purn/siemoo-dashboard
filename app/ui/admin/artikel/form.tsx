...
import { formSubmitHandlerArtikel } from "@/app/utils/actions";
...
export default function LoginForm() {
  const [code, action] = useFormState(formSubmitHandlerArtikel, undefined);
  const [image1, setImage1] = useState<File>();

  return (
    <form action={action} className="space-y-3">
      <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
        <h1 className={`${lusitana.className} mb-3 text-2xl`}>Tambah Artikel</h1>
